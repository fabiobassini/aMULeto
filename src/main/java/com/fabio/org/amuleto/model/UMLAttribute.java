...
/**
 * Rappresenta un attributo di una classe in un diagramma UML.
 * Un attributo è definito dalla sua visibilità, dal tipo e dal nome.
 */
public class UMLAttribute {
    ...
    /**
     * Restituisce una rappresentazione testuale dell'attributo in stile UML.
     * Il formato è "visibilità nome : tipo".
     *
