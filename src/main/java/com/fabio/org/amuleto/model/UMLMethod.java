...
/**
 * Rappresenta un metodo (o costruttore) in un diagramma UML.
 * Contiene informazioni sulla visibilità, sul tipo di ritorno, sul nome
 * e sui parametri del metodo.
 */
public class UMLMethod {
    ...
    /**
     * Converte il metodo in una rappresentazione testuale in stile UML.
     * Se la stringa dei parametri è vuota, non vengono mostrate le parentesi.
     *
     * Esempio di output: "+ metodo(param1, param2) : returnType" oppure
     * "+ costruttore : " (se non vi sono parametri).
     *
