...
/**
 * Rappresenta il modello del diagramma UML.
 * Contiene le collezioni di forme UML (classi, interfacce, ecc.) e le
 * connessioni
...
public class UMLDiagram {
    ...
    /**
     * Costruttore predefinito che inizializza le liste delle forme e delle
     * connessioni.
     */
    public UMLDiagram() {
