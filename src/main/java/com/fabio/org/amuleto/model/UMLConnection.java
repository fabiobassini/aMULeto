...
/**
 * Rappresenta una connessione (relazione) tra due forme UML.
 * Contiene informazioni sulla forma sorgente, forma di destinazione, tipo di
 * relazione
 * e le molteplicità associate a entrambe le estremità della connessione.
 */
public class UMLConnection {
    ...
    /**
     * Esegue il rendering grafico della connessione sul contesto grafico fornito.
     * Calcola i centri delle forme sorgente e di destinazione e disegna una linea
     * che le collega. Se la relazione prevede molteplicità, queste vengono
     * disegnate
     * vicino ai centri delle forme. In base al tipo di relazione, vengono disegnati
     * anche
     * simboli specifici (ad esempio, freccia per l'ereditarietà o diamante per
     * l'aggregazione).
     *
    ...
    /**
     * Disegna la freccia di ereditarietà (o implementazione) in prossimità del
     * punto di destinazione della connessione.
     *
     ...
     * @param x2     La coordinata X del punto di arrivo.
     * @param y2     La coordinata Y del punto di arrivo.
     * @param filled true se il diamante deve essere riempito (composizione), false
     *               se deve essere solo delineato (aggregazione).
     */
    private void drawAggregationDiamond(Graphics2D g, int x1, int y1, int x2, int y2, boolean filled) {
