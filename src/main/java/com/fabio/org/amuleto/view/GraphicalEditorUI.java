...
/**
 * Finestra principale dell'editor UML. Questa classe gestisce l'interfaccia grafica principale, il
 * menu, la sidebar e il canvas dove vengono disegnate le forme UML e le loro connessioni. Include
 * anche opzioni per salvare/caricare il diagramma in formato JSON, generare il codice UML e
 * generare/visualizzare un diagramma SVG.
 */
public class GraphicalEditorUI extends JFrame {
  ...
  /**
   * Costruttore della finestra principale. Imposta il titolo, le dimensioni e inizializza il
   * modello, il canvas e il controller.
   */
  ...
  /**
   * Inizializza i componenti dell'interfaccia grafica, inclusa la sidebar, il pannello principale e
   * il menu.
   */
  ...
  /**
   * Crea e restituisce la sidebar contenente i pulsanti e i controlli per aggiungere forme,
   * selezionare il tipo di relazione, controllare lo zoom e il layout automatico.
   *
  ...
  private JPanel createSidebar() {
    ...
    addClassBtn.addActionListener(
        (ActionEvent e) -> {
          String className =
              JOptionPane.showInputDialog(GraphicalEditorUI.this, "Nome della Classe:");
    ...
    addInterfaceBtn.addActionListener(
        (ActionEvent e) -> {
          String interfaceName =
              JOptionPane.showInputDialog(GraphicalEditorUI.this, "Nome dell'Interfaccia:");
    ...
    addAssocClassBtn.addActionListener(
        (ActionEvent e) -> {
          String assocName =
              JOptionPane.showInputDialog(GraphicalEditorUI.this, "Nome della Classe Associativa:");
  ...
  /**
   * Genera il codice UML in formato PlantUML partendo dal contenuto del canvas. Costruisce una
   * stringa contenente la definizione delle classi e delle relazioni, e la visualizza in un
   * dialogo.
   */
  ...
  /**
   * Mostra il file SVG generato in una nuova finestra. Viene creato un JSVGCanvas per visualizzare
   * l'SVG, con supporto per il pan (interazione predefinita) e uno slider per il controllo dello
   * zoom. Il file SVG è stato salvato nella cartella "aMULeto" sul Desktop.
   *
