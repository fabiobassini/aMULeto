...
/**
 * Rappresenta graficamente una classe (o interfaccia) in un diagramma UML.
 * Gestisce la posizione, la dimensione e il rendering degli elementi (nome,
 * attributi, costruttori, metodi) della classe.
 */
public class UMLClassShape {
    ...
    /**
     * Costruttore che inizializza il nome della classe e la posizione (x, y).
     * Inizializza anche le liste degli attributi, metodi e costruttori.
     *
    ...
    /**
     * Calcola l'altezza necessaria per disegnare il contenuto della classe,
     * includendo nome, attributi, costruttori e metodi.
     *
    ...
    private int computeHeight(Graphics g) {
        ...
        int total = 10 + headerHeight + 1 + attrHeight + (attrHeight > 0 ? 1 : 0)
                + consHeight + (consHeight > 0 ? 1 : 0)
                + methHeight + 10;
        return total;
    }
    ...
    /**
     * Verifica se il punto specificato è contenuto all'interno dei confini della
     * classe.
     *
    ...
    /**
     * Esegue il rendering della classe sul contesto grafico fornito, disegnando
     * il rettangolo, il nome e le sezioni (attributi, costruttori e metodi) con
     * separatori e spaziature adeguate.
     *
     ...
     * Dopo la chiusura del dialogo viene forzato il repaint del componente
     * proprietario per aggiornare la visualizzazione.
     *
