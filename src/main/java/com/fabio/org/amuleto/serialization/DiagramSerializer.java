...
/**
 * Classe responsabile della serializzazione e deserializzazione del modello
 * UMLDiagram.
 * Utilizza Gson per convertire l'oggetto UMLDiagram in formato JSON e
 * viceversa.
 */
public class DiagramSerializer {
    ...
    /**
     * Deserializza il contenuto di un file JSON per ricostruire un'istanza di
     * UMLDiagram.
     *
