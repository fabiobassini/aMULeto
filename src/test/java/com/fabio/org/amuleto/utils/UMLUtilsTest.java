...
public class UMLUtilsTest {
    ...
    /**
     * Test per il metodo isCollectionType.
     * Verifica che il metodo restituisca true per i tipi di collezione comuni
     * e false per tipi che non sono collezioni.
     */
    @Test
    ...
    /**
     * Test per il metodo isPrimitiveOrJavaType.
     * Verifica che il metodo riconosca correttamente i tipi primitivi e i tipi
     * built-in di Java, restituendo true per questi tipi e false per tipi non
    ...
    /**
     * Test per il metodo getVisibilitySymbol.
     * Questo test è un placeholder e dovrebbe essere implementato in base alla
     * struttura del nodo che rappresenta un campo nel codice.
     * Il test verifica la visibilità di un campo attraverso i modificatori
     * (ad esempio, pubblico, privato, protetto, package-private).
     * Implementare test specifici in base alla logica della struttura di nodi
     * utilizzata nella tua applicazione.
     */
    @Test
