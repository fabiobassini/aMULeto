...
public class UMLGeneratorTest {
    ...
    /**
     * Test per la generazione di un diagramma UML in formato PlantUML a partire
     * da una directory di codice sorgente.
     * Verifica che il file di output venga correttamente creato nella directory
     * specificata.
     *
     * @throws Exception Se si verifica un errore durante la generazione del
     *                   diagramma.
     */
    @Test
    ...
    /**
     * Test per la generazione di un diagramma UML in formato vettoriale (SVG)
     * a partire da una directory di codice sorgente.
     * Verifica che il file SVG di output venga correttamente creato.
     *
     * @throws Exception Se si verifica un errore durante la generazione del
     *                   diagramma SVG.
     */
    ...
    public void testGenerateVectorFromDirectory() throws Exception {
        ...
        UMLGenerator.generateVectorFromDirectory(sourceDir, outputFile, net.sourceforge.plantuml.FileFormat.SVG);
