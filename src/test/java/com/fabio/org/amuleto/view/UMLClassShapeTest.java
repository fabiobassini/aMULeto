...
public class UMLClassShapeTest {
  ...
  /**
   * Test per il metodo addAttribute. Verifica che un attributo venga correttamente aggiunto alla
   * classe UML. Dopo l'aggiunta, controlla che la lista degli attributi contenga esattamente
   * l'attributo aggiunto.
   */
  @Test
  ...
  /**
   * Test per il metodo addMethod. Verifica che un metodo venga correttamente aggiunto alla classe
   * UML. Dopo l'aggiunta, controlla che la lista dei metodi contenga esattamente il metodo
   * aggiunto.
   */
  @Test
  ...
  /**
   * Test per il metodo getClassName. Verifica che il nome della classe venga restituito
   * correttamente.
   */
  @Test
  ...
  /**
   * Test per il metodo setLocation. Verifica che la posizione della classe venga aggiornata
   * correttamente.
   */
  @Test
